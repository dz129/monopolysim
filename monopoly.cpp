...
int main(){
    ...
    for (int i = 0; i < balances.size(); i++){
        if (balances[i] > 0){
            ...
            winners.open("C:/Users/laser/Desktop/C++/monopoly/winners.txt");
            winners << i;
            std::ofstream colorf;
            colorf.open("C:/Users/laser/Desktop/C++/monopoly/colors.txt", std::ios_base::app);
            if (colorf.is_open()){
                std::cout << "color open";
                for (int i = 0; i < colorfrequency.size(); i++){
                    colorf << colorfrequency[i] << "\n";
                    std::cout << "wrote";
                }
                colorf.close();
            }
            std::ofstream propf;           
            propf.open("C:/Users/laser/Desktop/C++/monopoly/properties.txt", std::ios_base::app);
            if (propf.is_open()){
                std::cout << "prop open";
                for (int i = 0; i < propfrequencey.size(); i++){
                    propf << propfrequencey[i] << "\n";
                    std::cout << "wrote";
                }
            }
        }
    ...
    for (int i = 0; i < colorfrequency.size(); i++){
        std::cout << colorfrequency[i] <<"\n";
    }
    for (int i = 0; i < propfrequencey.size(); i++){
        std::cout << propfrequencey[i] <<"\n";
    }
